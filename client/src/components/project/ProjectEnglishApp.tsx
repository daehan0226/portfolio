...
const ProjectEnglishApp:FC = () => {
  ...
  return (
    <Box>
      <ProjectHeader 
        href={process.env.REACT_APP_PROJECT_ENGLISH_APP_LINK} 
        title={translate("englihAppName")} 
      />
      <Box 
        sx={{ 
          display: 'flex', 
      ...
      >
        ...
        <Box sx={{ padding: {mobile:1, tablet: 2}}}>
            <ProjectFeatureBox name={"englishApp"} title={"Front"} features={[
              translate("englihAppFrontFeatureOne"),
              translate("englihAppFrontFeatureTwo"),
              ]}
            />
            <Link href={process.env.REACT_APP_PROJECT_ENGLISH_APP_GITHUB_FRONT} >
              <GitHubIcon />
            </Link>
            <ProjectFeatureBox name={"englishApp"} title={"Back"} features={[
              translate("englihAppBackFeatureOne"),
              translate("englihAppBackFeatureTwo")
              ]}
            />
            <Link href={process.env.REACT_APP_PROJECT_ENGLISH_APP_GITHUB_BACK} >
              <GitHubIcon />
            </Link>
            <ProjectFeatureBox name={"englishApp"} title={"Crawler"} features={[
              translate("englihAppCrawlerFeatureOne")
              ]}
            />
